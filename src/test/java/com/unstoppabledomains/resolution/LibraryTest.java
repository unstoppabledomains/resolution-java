...
public class LibraryTest {
    ...
    public void namehash() {
        TestUtils.checkAnswer(() -> resolution.namehash("crypto"),
                "0x0f4a10a4f46c288cea365fcf45cccf0e9d901b945b9829ccdb54c10dc3cb7a6f");
    }

    @Test
    public void namehash2() {
        TestUtils.checkAnswer(() -> resolution.namehash("brad.crypto"),
    ...
    @Test
    public void addr() {
        TestUtils.checkAnswer(() -> resolution.addr("homecakes.crypto", "eth"),
    ...
    public void ipfsHash() {
        TestUtils.checkAnswer(() -> resolution.ipfsHash("brad.crypto"), "QmRsDVRwtdhhgznt3VZerdqcJwdQCQv9axZcy3F5hXh5P5");
    }

    @Test
    public void ownerTest() {
        TestUtils.checkAnswer(() -> resolution.owner("brad.crypto"), "0x8aad44321a86b170879d7a244c1e8d360c99dda8");
    }

...
public class UNSTest {
  ...
  @InjectMocks
  private UNS uns = new UNS(new UNSConfig(new NSConfig(Network.MAINNET, "example.com", "0x01"), new NSConfig(Network.MATIC_MAINNET, "example.com", "0x02")), new DefaultProvider(), resolver);
